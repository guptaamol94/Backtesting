...
for i, row in df.iterrows():
    ...
    # ── Same day square off check ─────────────────────────
    if in_trade and position > 0:
        # Check karo entry aur exit same din hai
        ...
        # Agar agle din aa gaye aur position abhi bhi hai — force close
        elif not same_day:
    ...
    # ── Entry — 3:00 PM ke baad entry nahi ───────────────
...
print("=" * 52)
print("  NIFTY INTRADAY BACKTEST (FIXED) — 60 Days")
print("=" * 52)
...
ax1.set_title('Nifty Intraday Backtest (Fixed) — 15 Min — 60 Days')
