...
SYMBOL    = "^NSEBANK"
CAPITAL   = 100000
STOP_LOSS = 0.006   # Bank Nifty volatile hai — thoda loose
...
print("\n" + "=" * 52)
print("   BANK NIFTY EMA + RSI BACKTEST — 60 Days")
print("=" * 52)
...
ax1.set_title('Bank Nifty EMA + RSI Backtest — 15 Min — 60 Days')
ax1.set_ylabel('Portfolio Value (Rs.)')
ax1.legend()
ax1.grid(True, alpha=0.3)

ax2.plot(df.index, df['Close'], color='black',  linewidth=0.8, label='BankNifty Close')
